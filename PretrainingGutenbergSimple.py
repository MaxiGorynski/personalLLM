"""
Based on code by Sebastian Raschka in "Build an LLM From Scratch"
...
import GPTModel
import GenerateAndPrintSample
import CalcLossBatch
        ...
        for epoch in range(n_epochs):
            ...
            for index, file_path in enumerate(all_files, 1):
                ...
                for input_batch, target_batch in train_loader:
                    optimizer.zero_grad()
                    loss = CalcLossBatch(input_batch, target_batch, model, device)
                    loss.backward()
                    optimizer.step()
                    ...
                    if global_step % eval_freq == 0:
                        train_loss, val_loss = EvaluateModel(
...
if __name__ == "__main__":
    ...
    PlotLosses(epochs_tensor, tokens_seen, train_losses, val_losses, output_dir)
